...
function App() {
  ...
  const { messages, isLoading, sendMessage, clearChat, previousQuestions } = useChat(selectedModel);


  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900">
      <div className="container mx-auto px-4 py-6 h-screen flex flex-row max-w-6xl gap-4">
        <Sidebar questions={previousQuestions} onSelect={(q) => sendMessage(q)} />
